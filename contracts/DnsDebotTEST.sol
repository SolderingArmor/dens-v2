...
import "../contracts/DnsRecordDeployerTEST.sol";
...
contract DnsDebot is Debot, Upgradable, DnsFunctionsCommon
{
    ...
    function onMsigEnter_2(int256 value) public 
    {
        ...
        Terminal.print(0, "Please give it ~20 seconds to process and then reload Whois to get latest domain information.\nPlease DO NOT deploy the same domain multiple times in a row!");
    ...
    {
        require(msg.value >= 1.4 ton, ERROR_NOT_ENOUGH_MONEY);
